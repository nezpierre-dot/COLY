...
BEGIN
  -- Get mission details
  SELECT user_id, product_name, prix_max, country, city
  INTO _mission
  ...
  -- Try to find the voyageur's relevant voyage for departure info
  ...
  IF _convo_id IS NULL THEN
    ...
    -- Voyageur acceptance message
    INSERT INTO public.messages (conversation_id, sender_id, content)
    VALUES (_convo_id, _voyageur_id, _msg);

    -- Auto-reply from demandeur asking for proof
