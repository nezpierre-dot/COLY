...
// FAQ data stays in French as content — could be translated later
const faqData: FaqCategory[] = [
  ...
  {
    id: "envois", icon: Package, label: "Envois de colis",
    items: [
      { q: "Comment envoyer un colis ?", a: "Rendez-vous dans l'espace Demandeur, cliquez sur 'Envoyer un coly', remplissez les informations (destination, taille, tarif proposé) et attendez qu'un voyageur accepte votre envoi." },
  ...
  {
    id: "voyages", icon: Plane, label: "Voyages",
    items: [
      { q: "Comment proposer un voyage ?", a: "Dans l'espace Voyageur, cliquez sur 'Ajouter un voyage'. Indiquez votre trajet (départ, arrivée), les dates, le moyen de transport et vos préférences." },
  ...
  {
    id: "needit", icon: ShoppingCart, label: "Missions NeedIt",
    items: [
  ...
  {
    id: "paiement", icon: CreditCard, label: "Paiements",
    items: [
  ...
  {
    id: "securite", icon: Shield, label: "Sécurité & Vérification",
    items: [
