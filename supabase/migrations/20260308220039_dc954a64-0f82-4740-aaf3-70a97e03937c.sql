...
-- Function: get_matching_voyageurs
-- Returns top matching voyageurs for a given destination, sorted by rating + date proximity
...
CREATE INDEX IF NOT EXISTS idx_voyages_active_destination
ON public.voyages (arrival_country, arrival_city, departure_date)
WHERE status = 'active';
