...
const EmptyState = ({ icon: Icon, title, description, action }: EmptyStateProps) => (
  ...
  >
    <motion.div
      ...
      className="w-20 h-20 rounded-3xl bg-muted/80 flex items-center justify-center mb-4"
    >
    ...
    <motion.p
      ...
      className="text-sm text-muted-foreground mt-1.5 text-center max-w-[260px]"
    >
      {description}
    </motion.p>
    {action && (
